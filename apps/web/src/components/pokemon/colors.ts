...
const colors: ByType = {
  ...
  steel: { background: 'bg-zinc-300', tag: 'bg-zinc-700' },
  ...
  dragon: { background: 'bg-indigo-300', tag: 'bg-indigo-700' },
  dark: { background: 'bg-neutral-400', tag: 'bg-neutral-700' },
  fairy: { background: 'bg-pink-500', tag: 'bg-pink-700' },
  unknown: { background: 'transparent', tag: 'transparent' },
  shadow: { background: 'bg-neutral-400', tag: 'bg-neutral-700' },
};
